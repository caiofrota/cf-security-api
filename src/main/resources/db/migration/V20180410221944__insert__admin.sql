-- SUPERADMIN
insert into cf_users (created_by, created_on, updated_by, updated_on, email, enabled, superadmin, name, password)
              values (1, now(), 1, now(), 'superadmin@cftechsol.com', 1, 1, 'Super Admin', '$2a$10$Lmz/VVefxOTeZmUK8/Tg4uHVmh0nmHz1kaTg0gMkxkkYo/rJcXBwi')
;

insert into cf_roles (created_by, created_on, updated_by, updated_on, cod, superadmin)
              values (1, now(), 1, now(), 'SUPERADMIN', 1)
;

insert into cf_permissions (created_by, created_on, updated_by, updated_on, cod, superadmin)
                    values (1, now(), 1, now(), 'SUPERADMIN', 1)
;
